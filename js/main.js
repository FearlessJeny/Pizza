...
sr.reveal(`.home__board-he`, {delay: 700, distance: '100px', origin: 'left'})
sr.reveal(`.home__pizza-he`, {delay: 1400, distance: '100px', origin: 'bottom', rotate: {z: 90}})
sr.reveal(`.about__data-he, .recipe__list-he, .contact__data-he`, {origin: 'left'})
sr.reveal(`.about__img-he, .recipe__img-he, .contact__image-he`, {origin: 'right'})
...
// Выставляем активную кнопку при загрузке
...
buttons.forEach(btn => {
    ...
    btn.addEventListener("click", () => {
        ...
        if (lang === "ru") {
            ...
            window.location.href = "indexhe.html";
        }
    });
});